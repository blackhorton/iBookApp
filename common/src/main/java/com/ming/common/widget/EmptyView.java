package com.ming.common.widget;
...
import com.ming.common.widget.conversation.PlaceHolderView;
...
public class EmptyView extends LinearLayout implements PlaceHolderView {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mTextIds[1] = array.getInt(R.styleable.EmptyView_comErrorText, R.string.prompt_error);
        mTextIds[2] = array.getInt(R.styleable.EmptyView_comLoadingText, R.string.prompt_loading);
